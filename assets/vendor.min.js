...
$(document).ready(function() {
    ...
    if (m < 0 || (m === 0 && today.getDate() < inputDate.getDate())) { age--; }
	...
	$('#studentForm').trigger('click');
		...
		$("#studentDetails").validate({
			...
			jQuery.getJSON('/cart.js', function (cart, textStatus) {
    			...
    			$.ajax({
                  url: "https://mindmax-stage.demandtech.org/BUFinancialPlanning/ajax.php", 
                  type: "POST",             
                  data: $(form).serialize()+"&token=" + cart.token + "&items=",
                  cache: false,             
                  processData: false,      
                  success: function(data) {
                    ...
                    if( response.status === 200 ){
						const checkoutData = jQuery.param( response.data );
						 window.location = '/checkout?'+ checkoutData;
					}
                  }
